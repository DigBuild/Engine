...
namespace DigBuild.Engine.Render.Worlds
{
    ...
    {
        /// <summary>
        /// Whether a computationally heavy update is scheduled.
        /// </summary>
        bool HasHeavyUpdate { get; }
        /// <summary>
        /// Updates the geometry.
        /// </summary>
        /// <param name="express">Whether a quick or complete update should be performed</param>
